...
class CIFAR_10(BaseDataset):
    ...
    def evaluate(
        ...
        # allowed_metrics = [
        #     'accuracy', 'precision', 'recall', 'f1_score', 'support', 'per_class_precision'
        # ]
        eval_results = {}
        ...
        #     num_classes = len(np.unique(gt_labels))  # Get the number of classes
        #     per_class_precision = calculate_per_class_precision(results, gt_labels, num_classes)
        #     for i, precision in enumerate(per_class_precision):
        #         eval_results[f'precision_class_{i}'] = precision.item()
