...
from configs.reid.data import make_data_loader
from configs.reid.data.transforms import build_transforms
from AGR.reid import build_model
...
import sys
import os
# 获取当前文件所在目录（即 person_search 文件夹）
...
if __name__ == '__main__':
    ...
    parser.add_argument('--A_D_config', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/configs/det/linear_probe/faster_rcnn/central_r50_fpn_Up-G-D_pretrain_part1-A-G.py',
                        help="空中实时检测-配置文件路径")
    parser.add_argument('--A_D_checkpoint', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/person_search/weights/part1-2/Detweight-central_r50_fpn_Up-G-D_pretrain_part1-A-G.pth',
                        help="空中实时检测-权重文件路径")
    parser.add_argument('--A_D_input', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/person_search/data/1A-D-I/c1s1_800.MP4',
                        help="空中实时检测-输入图像或视频文件路径")
    parser.add_argument('--A_D_output', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/person_search/data/2A-D-O_and_get-query-input/c1s1_800_detected.mp4',
    ...
    parser.add_argument('--query_output', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/person_search/data/3query_out',
    ...
    parser.add_argument('--images', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/person_search/data/4Reid-gallery_and_G-D-I/c2s1_100.mp4',
                        help='地面需要进行检测并reid的图片或视频文件夹')
    parser.add_argument('--ps_output', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/person_search/data/5Person-search-Out',
                        help='person-search检测后的图片或视频保存的路径')
    parser.add_argument('--gs_output', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/person_search/data/6G-S-I_and_proc-of-search-out',
    ...
    parser.add_argument('--find_class', type=str, default='person', help='所要寻找目标的类别-需标定以快速筛选')

    # ==== 分割 ====
    parser.add_argument('--G_S_config_file', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/configs/seg/linear_probe/deeplabv3/r50_UP-G_Seg-Person-Car-voc-part1_2_20k.py',
                        help="Path to the config file.")
    parser.add_argument('--G_S_checkpoint_file', type=str,
                        default='。。。。。这里你自己补充一下/2030pj-finish-for-car/person_search/weights/part1-2/SEG-weight-up-G.pth',
                        help="Path to the checkpoint file.")
    parser.add_argument('--G_S_input_path', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/person_search/data/6G-S-I_and_proc-of-search-out',
                        help="Path to the input image file.")
    parser.add_argument('--G_S_output_path', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/person_search/data/7G-S-O',
                        help="Path to save the output results.")
    parser.add_argument('--G_S_video_output_path', type=str,
                        default='/home/zjnu/GZP/2030_pj/2030pj-finish-for-car/person_search/data/8seg_video',
